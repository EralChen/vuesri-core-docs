import{Db as I,Dc as $,DC as O,eL as l,Dd as c,DD as b,DE as S,DF as A,Df as C,Dp as p,vG as P,DG as x,DH as u,DI as w,lW as E,$ as i,DJ as o,ij as g,Dg as N,DK as R,Dh as V,Di as L,Dk as M,DL as F,DM as U,DN as G,DO as W,DP as j,Dm as z,DQ as B,DR as H,DS as k,DT as Q,Do as q,nd as D,DU as m,DV as J,DW as K,Ds as X,DX as Y,Dr as Z,CT as ee,DY as te,DZ as se,ou as ae,D_ as re}from"./chunk-5cgByRBI.js";import{_ as ie}from"./chunk-_HEdEAnB.js";function y(s){const e=new I,{vertex:t,fragment:a}=e;return $(t,s),e.include(O,s),e.attributes.add(l.POSITION,"vec3"),e.attributes.add(l.UV0,"vec2"),s.perspectiveInterpolation&&e.attributes.add(l.PERSPECTIVEDIVIDE,"float"),e.varyings.add("vpos","vec3"),s.multipassEnabled&&e.varyings.add("depth","float"),t.code.add(c`
    void main(void) {
      vpos = position;
