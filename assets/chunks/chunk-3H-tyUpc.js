import{D4 as $,D5 as I,D6 as O,e5 as l,D7 as c,D8 as b,D9 as S,Da as A,Db as x,Dc as p,vw as P,Dd as C,De as u,Df as w,lS as y,$ as i,Dg as o,kt as g,Dh as N,Di as R,Dj as V,Dk as M,Dl as F,Dm as L,Dn as z,Do as B,Dp as U,Dq as j,Dr as G,Ds as W,Dt as k,Du as q,Dv as H,Dw as J,na as D,Dx as m,Dy as Q,Dz as K,DA as X,DB as Y,DC as Z,CJ as ee,DD as te,DE as se,oq as ae,DF as re}from"./chunk-Id6bT2Sz.js";import{_ as ie}from"./chunk-f83L__eB.js";function E(s){const e=new $,{vertex:t,fragment:a}=e;return I(t,s),e.include(O,s),e.attributes.add(l.POSITION,"vec3"),e.attributes.add(l.UV0,"vec2"),s.perspectiveInterpolation&&e.attributes.add(l.PERSPECTIVEDIVIDE,"float"),e.varyings.add("vpos","vec3"),s.multipassEnabled&&e.varyings.add("depth","float"),t.code.add(c`
    void main(void) {
      vpos = position;
