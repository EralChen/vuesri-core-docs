import{D3 as $,D4 as I,D5 as O,e5 as l,D6 as c,D7 as b,D8 as S,D9 as A,Da as x,Db as p,vv as P,Dc as C,Dd as u,De as w,lS as y,$ as i,Df as o,kt as g,Dg as N,Dh as R,Di as V,Dj as L,Dk as M,Dl as F,Dm as z,Dn as B,Do as U,Dp as j,Dq as G,Dr as W,Ds as k,Dt as H,Du as q,Dv as Q,na as D,Dw as m,Dx as J,Dy as K,Dz as X,DA as Y,DB as Z,CL as ee,DC as te,DD as se,op as ae,DE as re}from"./chunk-oRXQYLok.js";import{_ as ie}from"./chunk-I9oa6RJ6.js";function E(s){const e=new $,{vertex:t,fragment:a}=e;return I(t,s),e.include(O,s),e.attributes.add(l.POSITION,"vec3"),e.attributes.add(l.UV0,"vec2"),s.perspectiveInterpolation&&e.attributes.add(l.PERSPECTIVEDIVIDE,"float"),e.varyings.add("vpos","vec3"),s.multipassEnabled&&e.varyings.add("depth","float"),t.code.add(c`
    void main(void) {
      vpos = position;
