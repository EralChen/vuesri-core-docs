import{Dd as $,De as I,DE as O,eL as l,Df as c,DF as S,DG as b,DH as A,Dh as x,Dr as p,vF as P,DI as C,DJ as u,DK as w,lW as E,$ as i,DL as o,ij as g,Di as N,DM as R,Dj as V,Dk as L,Dm as M,DN as F,DO as U,DP as j,DQ as W,DR as z,Do as B,DS as G,DT as H,DU as k,DV as q,Dq as Q,nd as D,DW as m,DX as J,DY as K,Du as X,DZ as Y,Dt as Z,CS as ee,D_ as te,D$ as se,ou as ae,E0 as re}from"./chunk-xMPjLCrx.js";import{_ as ie}from"./chunk-Qgrzwe6s.js";function y(s){const e=new $,{vertex:t,fragment:a}=e;return I(t,s),e.include(O,s),e.attributes.add(l.POSITION,"vec3"),e.attributes.add(l.UV0,"vec2"),s.perspectiveInterpolation&&e.attributes.add(l.PERSPECTIVEDIVIDE,"float"),e.varyings.add("vpos","vec3"),s.multipassEnabled&&e.varyings.add("depth","float"),t.code.add(c`
    void main(void) {
      vpos = position;
