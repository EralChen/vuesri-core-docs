import{Dd as I,De as $,DE as O,eL as l,Df as c,DF as S,DG as b,DH as A,Dh as x,Dr as p,vI as P,DI as C,DJ as u,DK as w,lX as E,$ as i,DL as o,ij as g,Di as N,DM as R,Dj as V,Dk as L,Dm as M,DN as F,DO as U,DP as j,DQ as z,DR as B,Do as G,DS as W,DT as H,DU as k,DV as q,Dq as Q,ne as D,DW as m,DX as X,DY as J,Du as K,DZ as Y,Dt as Z,CV as ee,D_ as te,D$ as se,ov as ae,E0 as re}from"./chunk-fHrNL0KE.js";import{_ as ie}from"./chunk-0wTVHGNT.js";function y(s){const e=new I,{vertex:t,fragment:a}=e;return $(t,s),e.include(O,s),e.attributes.add(l.POSITION,"vec3"),e.attributes.add(l.UV0,"vec2"),s.perspectiveInterpolation&&e.attributes.add(l.PERSPECTIVEDIVIDE,"float"),e.varyings.add("vpos","vec3"),s.multipassEnabled&&e.varyings.add("depth","float"),t.code.add(c`
    void main(void) {
      vpos = position;
